...
export interface MarkerAttrs extends ShapeAttrs {
    ...
    y: number;
    radius: number;
    symbol: 'circle' | 'square' | ((x: number, y: number, r: number, ctx: CanvasRenderingContext2D) => void);
}
export interface RectAttrs extends ShapeAttrs {
    ...
    width: number;
    height: number;
    radius?: number | string | [string | number] | [string | number, string | number] | [string | number, string | number, string | number] | [string | number, string | number, string | number, string | number];
}
